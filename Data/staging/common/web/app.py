...
# Import our services
# Import our services
from staging.common.services.file_discovery import FileDiscoveryService, get_file_discovery_service
from staging.common.services.ingestion_worker import IngestionWorker, IngestionProgress
...
def styles():
    """Serve the CSS file from templates."""
    return send_from_directory('templates', 'styles.css')


@app.route('/app.js')
def scripts():
    """Serve the JS file from templates."""
